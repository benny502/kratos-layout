...
func (x *Log) GetOutputDir() string {
	if x != nil {
		return x.OutputDir
	}
	return ""
...
type App struct {
	...
	Mail  *App_Mail  `protobuf:"bytes,1,opt,name=mail,proto3" json:"mail,omitempty"`
	Etcd  *App_Etcd  `protobuf:"bytes,2,opt,name=etcd,proto3" json:"etcd,omitempty"`
	Redis *App_Redis `protobuf:"bytes,3,opt,name=redis,proto3" json:"redis,omitempty"`
}
...
type Data_Mysql struct {
	...
	ConnMaxLifetime int32  `protobuf:"varint,2,opt,name=conn_max_lifetime,json=connMaxLifetime,proto3" json:"conn_max_lifetime,omitempty"`
	...
	PrepareStmt     bool   `protobuf:"varint,5,opt,name=prepare_stmt,json=prepareStmt,proto3" json:"prepare_stmt,omitempty"`
	TablePrefix     string `protobuf:"bytes,6,opt,name=table_prefix,json=tablePrefix,proto3" json:"table_prefix,omitempty"`
	SingularTable   bool   `protobuf:"varint,7,opt,name=singular_table,json=singularTable,proto3" json:"singular_table,omitempty"`
	LogMode         string `protobuf:"bytes,8,opt,name=logMode,proto3" json:"logMode,omitempty"`
}
...
func (x *Data_Mysql) GetConnMaxLifetime() int32 {
	if x != nil {
...
func (x *Data_Mysql) GetPrepareStmt() bool {
	if x != nil {
...
func (x *Data_Mysql) GetTablePrefix() string {
	if x != nil {
...
func (x *Data_Mysql) GetSingularTable() bool {
	if x != nil {
...
func (x *Data_Mysql) GetLogMode() string {
	if x != nil {
		return x.LogMode
	}
	return ""
...
type App_Mail struct {
	...
	Smtpauth bool   `protobuf:"varint,5,opt,name=smtpauth,proto3" json:"smtpauth,omitempty"`
	From     string `protobuf:"bytes,6,opt,name=from,proto3" json:"from,omitempty"`
	Receive  string `protobuf:"bytes,7,opt,name=receive,proto3" json:"receive,omitempty"`
	Secure   string `protobuf:"bytes,8,opt,name=secure,proto3" json:"secure,omitempty"`
}

func (x *App_Mail) Reset() {
	*x = App_Mail{}
	if protoimpl.UnsafeEnabled {
...
func (x *App_Mail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*App_Mail) ProtoMessage() {}

func (x *App_Mail) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use App_Mail.ProtoReflect.Descriptor instead.
func (*App_Mail) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 0}
}

func (x *App_Mail) GetServer() string {
	if x != nil {
		return x.Server
	}
	return ""
...
func (x *App_Mail) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *App_Mail) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *App_Mail) GetSmtpauth() bool {
	if x != nil {
		return x.Smtpauth
	}
	return false
...
func (x *App_Mail) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *App_Mail) GetReceive() string {
	if x != nil {
		return x.Receive
	}
	return ""
...
func (x *App_Mail) GetSecure() string {
	if x != nil {
		return x.Secure
	}
	return ""
...
func (x *App_Etcd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*App_Etcd) ProtoMessage() {}

func (x *App_Etcd) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use App_Etcd.ProtoReflect.Descriptor instead.
func (*App_Etcd) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 1}
}

func (x *App_Etcd) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *App_Etcd) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *App_Redis) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*App_Redis) ProtoMessage() {}

func (x *App_Redis) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use App_Redis.ProtoReflect.Descriptor instead.
func (*App_Redis) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 2}
}

func (x *App_Redis) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *App_Redis) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x70, 0x12, 0x24, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41,
	0x75, 0x74, 0x68, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0xcf, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2c, 0x0a,
	...
	0x79, 0x73, 0x71, 0x6c, 0x52, 0x05, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x1a, 0x98, 0x02, 0x0a, 0x05,
	0x4d, 0x79, 0x73, 0x71, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x73, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x64, 0x73, 0x6e, 0x12, 0x2a, 0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x6e, 0x5f,
	0x6d, 0x61, 0x78, 0x5f, 0x6c, 0x69, 0x66, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x37, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	0x16, 0x0a, 0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x6a, 0x77, 0x74, 0x5f, 0x6b,
	0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6a, 0x77, 0x74, 0x4b, 0x65, 0x79,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*App_Mail)(nil),            // 9: kratos.api.App.Mail
	(*App_Etcd)(nil),            // 10: kratos.api.App.Etcd
	(*App_Redis)(nil),           // 11: kratos.api.App.Redis
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.App.mail:type_name -> kratos.api.App.Mail
	10, // 9: kratos.api.App.etcd:type_name -> kratos.api.App.Etcd
	11, // 10: kratos.api.App.redis:type_name -> kratos.api.App.Redis
	...
	12, // 13: kratos.api.App.Etcd.timeout:type_name -> google.protobuf.Duration
